...
LISTENING_PORT = int(sys.argv[1]) if len(sys.argv) > 1 else 757  # default fallback if not specified via args
PASS = ''
BUFLEN = 4096 * 4
TIMEOUT = 60
DEFAULT_HOST = '127.0.0.1:22'
RESPONSE = (
    'HTTP/1.1 101 <b><u><font color="blue">Server By NiLphreakz</font></b>\r\n\r\n'
    'Content-Length: 104857600000\r\n\r\n'
)

MAX_THREADS = 100
thread_limiter = threading.BoundedSemaphore(value=MAX_THREADS)
